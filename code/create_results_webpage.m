...
% confusion matrix. Entry (i,j) in this matrix will be the proportion of
% times a test image of ground truth category i was predicted to be
% category j. An identity matrix is the ideal case.
...
fprintf(fid,'<center>\n');
fprintf(fid,'<h1>Computer Vision coursework visualisation</h1>\n');
